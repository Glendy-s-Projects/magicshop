...
const ResultadoCarousel = ({
  usuario,
  resultado,
  darkSide,
  activeIndex,
  setApi,
}: ResultadoCarouselProps) => {
  const arrowStyles =
    "bg-white text-black border-none dark:bg-black dark:text-white hover:bg-gray-500 dark:hover:bg-gray-500";
  ...
  return (
    <Carousel setApi={setApi}>
      <CarouselContent>
        ...
        <CarouselItem>
          <ResultadoCard2 usuario={usuario} isActive={activeIndex === 1} darkSide={darkSide} />
        </CarouselItem>
      </CarouselContent>
